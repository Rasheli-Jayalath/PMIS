...
$sql_pro= $objDb->dbQuery("INSERT INTO t012issues (pid, iss_no, iss_title, iss_detail, iss_status, iss_action, iss_remarks,attachment,iss_date,lid) Values(".$pid.",'".$iss_no."', '".$iss_title."', '".$iss_detail."', '".$iss_status."', '".$iss_action."', '".$iss_remarks."', '".$flink."', '".$iss_date."', '".$lid."')");
            ...
            <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8 text-start">
                            <input class="form-control"  style=" "   type="text" name="iss_date" id="iss_date"  autocomplete="off" value="<?php if(isset($iss_date)&&$iss_date!="0000-00-00"&&$iss_date!="1970-01-01")echo $iss_date; ?>" /> 
            ...
            <div class="row">
                       <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8 text-start">
                            <textarea   class="form-control" rows="4" style=" height: 100px; "  name="iss_title"><?php echo $iss_title; ?></textarea>
