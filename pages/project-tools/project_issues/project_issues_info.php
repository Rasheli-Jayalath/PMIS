...
<?php echo COMP; ?>:  <select class="" id="lid" name="lid" onchange="getDates(this.value)" style="width:15%; margin-right: 1%;">
			    ...
			    if($arightr[0]==$user_cd)
						{
                           ...
                           <?php
								 ...
								 if(isset($_REQUEST['iss_status']) && $_REQUEST['iss_status']!="")
							 {
								  ...
								  $pdSQL = "SELECT nos_id, pid, iss_no, iss_title, iss_detail, iss_status, iss_action, iss_remarks, attachment, lid FROM t012issues where pid=$pid and lid=$cmpid and iss_status=$status";
							 }
							 else
							 { 
