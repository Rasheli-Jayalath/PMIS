...
<button type="button" class="col-sm-2 button-33" onclick="location.href='RFI_input.php';"> <?php echo "Add New RFI"?> </button>
...
<!-- <div class="row pb-4 pt-3 text-end" >
 ...
 <div class="table-responsive">
                    <table class="table table-striped">
                      <thead>
                                <tr>
								  ...
								  <th  colspan="3" class="text-center"> Reports </th>	
              ...
              $pdSQL = "SELECT rfi_number, rfi_prev_ref, rfi_Date, rfi_activity_location FROM tbl_rfi_lab";
                            ...
                            <td>
                            <button type="button"  class="btn  btn-outline-primary btn-fw py-0 button-36 "   >   Quality Report </button>
                            </td>
                            <td>
                            <button type="button" class="btn  btn-outline-primary btn-fw py-0 button-36 "  > Survey Report </button>
                            </td>
                            <td>
                            <button type="button" class="btn  btn-outline-primary btn-fw py-0 button-36 "  >  Inspection Report </button>
                            </td>
							<td >
