 ...
 <?php
	...
	if($objNews->totalRecords() >= 1){
		...
		<td style="padding-left:20px; padding-right:20px; padding-top:20px;">
    		<div style="width:100%">
			<div style=" background:#FEFEFE; bawidth:15%; min-height:120px; float:left"  > <?php if($rows['newsfile']!="") {?> <a href="<?php echo NEWS_URL.$rows['newsfile'] ;?>" target="_blank"><img src="<?php echo "../News/".$rows['newsfile'] ;?>" border="0" width="80px" height="80px" /></a>
