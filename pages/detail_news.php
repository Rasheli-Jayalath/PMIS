 ...
 <?php
	...
	if($objNews->totalRecords() >= 1){
		...
		<td style="padding-left:20px; padding-right:20px; padding-top:20px;">
    		<div style="width:100%">
			<div style=" background:#FEFEFE; width:15%;  float:left"  > <?php if($rows['newsfile']!="") {?> <a href="<?php echo NEWS_URL.$rows['newsfile'] ;?>" data-lightbox="roadtrip"  data-title="image"><img src="<?php echo "../News/".$rows['newsfile'] ;?>" border="0" width="120px" height="120px" /></a>
		   ...
		   <?php
			...
			{ ?><a href="<?php echo NEWS_URL.$file1 ;?>" data-lightbox="roadtrip"  data-title="image"><img src="<?php echo "../News/".$file1 ;?>" border="0" width="120px" height="120px" /></a><?php }
			?></td>
			<td><?php if($file2!="")
