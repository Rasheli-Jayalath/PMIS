...
<tr>
        ...
        <td>
        <span style="float:left"><form action="sp_photo_album_input.php?phid=<?php echo $plevelrowt027['phid'] ?>&album_id=<?php echo $plevelrowt027['album_id']; ?>" method="post"><input type="submit" class="btn btn-warning btn-sm"name="edit" id="edit" value="Edit" /></form></span>
        <span style="float:right"><form action="sp_photo_album_input.php?phid=<?php echo $plevelrowt027['phid'] ?>&album_id=<?php echo $plevelrowt027['album_id']; ?>" method="post"><input type="submit" class="btn btn-danger btn-sm"name="delete" id="delete" value="Del" onclick="return confirm('Are you sure?')" /></form></span>
        </td>
        </tr>
