...
$sCondition = '';
?>
<select id="date_p" name="date_p"  class="form-control"  style="width: 160px;font-size: 14px; color: #000;background-color: #fff;">
  ...
  <select id="date_p2" name="date_p2"  class="form-control"  style="width: 160px;font-size: 14px; color: #000;background-color: #fff; margin-left: 10px;">
