...
$sCondition = '';
$ObjMapDrawings->setProperty("lcid",$lcid); 
$pictoalbumname = $ObjMapDrawings->getAllSubComponents(); 


?>
           <div class="form-group row" >
                      <label for="exampleInputUsername2" style="font-weight: bold; " class="col-sm-5 col-form-label rl-p0"> Sub Component</label>
                      <div class="col-sm-7 rl-p0" >
                      <select  id="canal_name" name="canal_name"  class="form-control"  style="font-size: 14px; color: #000;background-color: #fff;">
