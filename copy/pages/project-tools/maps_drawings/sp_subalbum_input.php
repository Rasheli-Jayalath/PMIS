...
{ 
    ...
    $ObjMapDrawing->setProperty("album_name",$album_name); 
    $ObjMapDrawing->setProperty("status",$status); 
    $ObjMapDrawing->setProperty("parental_id",$palid); 
    $pictoalbumname = $ObjMapDrawing->setSpSubAlbum(); 
...
{ 
	  ...
	  ///Insert data
    $ObjMapDrawing->setProperty("albumid",$_REQUEST['albumid']);
    $pictoalbumname = $ObjMapDrawing->deleteSpSubAlbum(); 
...
$ObjMapDrawing2->setProperty("albumid",$_REQUEST["parentid"]);
