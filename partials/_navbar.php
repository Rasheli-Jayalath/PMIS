...
>
  ...
  >
    ...
    <div>
      <a class="navbar-brand brand-logo" href="/PMIS/index.html">
        <img src="/PMIS/images/smec-logo.png" alt="logo" />
      </a>
      <a class="navbar-brand brand-logo-mini" href="/PMIS/index.html">
        <img src="/PMIS/images/logo-mini.svg" alt="logo" />
      </a>
    </div>
  </div>
    ...
    <ul class="navbar-nav">
      <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
        ...
        <h3 class="welcome-sub-text">
          Financial progress as per varified interim payment certificate (IPC)
        </h3>
      </li>
    </ul>
      ...
      <li class="nav-item dropdown">
        ...
        >
          ...
          <a class="dropdown-item preview-item">
            <div class="preview-thumbnail">
              <img
                src="/PMIS/images/faces/face10.jpg"
                alt="image"
          ...
          <a class="dropdown-item preview-item">
            <div class="preview-thumbnail">
              <img
                src="/PMIS/images/faces/face12.jpg"
                alt="image"
                class="img-sm profile-pic"
              />
            </div>
          ...
          <a class="dropdown-item preview-item">
            <div class="preview-thumbnail">
              <img
                src="/PMIS/images/faces/face1.jpg"
                alt="image"
                class="img-sm profile-pic"
              />
            </div>
      ...
      <li class="nav-item dropdown d-none d-lg-block user-dropdown">
        ...
        >
          <img
            ...
            src="/PMIS/images/faces/face8.jpg"
            alt="Profile image"
          />
        </a>
        <div
...
<!-- inject:js -->
<script src="/PMIS/js/off-canvas.js"></script>
<script src="/PMIS/js/hoverable-collapse.js"></script>
<script src="/PMIS/js/template.js"></script>
<script src="/PMIS/js/settings.js"></script>
<script src="/PMIS/js/todolist.js"></script>
<!-- <script src="/PMIS/js/navtype_session.js"></script> -->
<!-- endinject -->
